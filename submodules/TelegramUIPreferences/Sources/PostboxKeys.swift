...
public struct ApplicationSpecificSharedDataKeys {
    ...
    public static let shadowgramSettings: EngineDataBuffer = applicationSpecificSharedDataKey(ApplicationSpecificSharedDataKeyValues.shadowgramSettings.rawValue)
}
